...
// @ts-ignore
import { Render, ReactAdapter } from '../../render/index.umd.js';
// @ts-ignore
const jsonConver2Query = (json) => Object.keys(json)
    .map(function (key) {
    return encodeURIComponent(key) + '=' + encodeURIComponent(json[key]);
})
    .join('&');
// 页面schema数据
const pageSchema={"version":"1.0.0","name":"BaseDemoPage1","code":"asdahjsdbajkdbj","componentsMeta":[],"componentsTree":{"componentName":"RootContainer","props":{"a":1},"state":{"b":2,"buttonVisible":true,"modalVisible":false},"configure":{"propsSetter":{},"advanceSetter":{}},"children":[{"componentName":"Container","id":"ef9vms","title":"Container-bg","configure":{"propsSetter":{},"advanceSetter":{}}}]},"thirdLibs":[{"package":"dayjs","name":"dayjs","version":"1.0.0"},{"package":"antd","name":"antd","version":"1.0.0"}],"assets":[{"globalName":"dayjs","package":"dayjs","resources":[{"src":"https://cdn.bootcdn.net/ajax/libs/dayjs/1.11.7/dayjs.min.js"}]},{"globalName":"antd","package":"antd","resources":[{"src":"https://cdn.bootcdn.net/ajax/libs/antd/5.4.4/antd.js"},{"src":"https://cdn.bootcdn.net/ajax/libs/antd/5.4.4/reset.css"}]}]};
...
root.render(React.createElement(Render, { page: pageSchema, components: components, adapter: ReactAdapter }));
